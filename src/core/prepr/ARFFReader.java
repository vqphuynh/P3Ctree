...
/**
 * Numeric attributes will be discretized automatically by the default method FUSINTER. 
 * MDLP is also supported by changing the discretization method with method setDiscretMethod(DISCRETIZER.MDLP).
 */
public class ARFFReader extends DataReader {
	...
	/**
	 * @return Get the method which is used to discretize numeric attributes
	 */
	public DISCRETIZER getDiscretMethod() {
		return discret_method;
	}

	/**
	 * @param discret_method A method which is used to discrete numeric attributes: DISCRETIZER.MDLP or DISCRETIZER.FUSINTER
	 */
	public void setDiscretMethod(DISCRETIZER discret_method) {
